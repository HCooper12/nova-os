...
export const api = {
  ...
  setPortions: (conn, recipeId, count, name) => post(conn, '/api/portions', { recipeId, count, name }),
  adjustPortions: (conn, recipeId, delta, name) => post(conn, '/api/portions/adjust', { recipeId, delta, name }),
