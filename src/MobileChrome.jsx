  ...
  return (
    <>
      <div style={css("position:fixed;top:0;left:0;right:0;z-index:70;display:flex;align-items:center;gap:10px;padding:10px 16px;background:rgba(18,13,24,.92);backdrop-filter:blur(12px);border-bottom:1px solid rgba(236,229,218,.08)")}>
        ...
        <span style={css("margin-left:auto;display:flex;align-items:center;gap:7px;font:500 9px 'JetBrains Mono',monospace;letter-spacing:.12em;color:#6be5f5")}><span style={css("width:5px;height:5px;border-radius:50%;background:#6be5f5;animation:novaPulse 2s infinite")}></span>3 LIVE</span>
