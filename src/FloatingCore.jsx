...
// pulsing = the mic is actually open), and tapping it opens the
// conversation. The canvas animates on its own rAF (see NovaCore) and the
// ring states arrive as props on normal renders — nothing here ticks state.
export function FloatingCore({ s }) {
  return (
    ...
    >
      ...
      <NovaCore size={44} variant="mini" style={{ pointerEvents: 'none' }} />
    </Interactive>
  );
}
