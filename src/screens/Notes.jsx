    ...
    <div style={v.wrapNotes} data-screen-label="Notes">
      ...
      <div style={v.gridNotes}>
          ...
          <div style={css("flex:1;overflow-y:auto;padding:0 8px 10px;display:flex;flex-direction:column;gap:2px")}>
            {v.noteList.map((n, i) => (
              <Interactive key={i} onClick={n.select} onPointerDown={n.warm} base={n.style} hoverStyle="background:rgba(255,255,255,.05)">
                ...
                <div style={css("margin-top:3px;font:var(--nv-micro-m);color:color-mix(in srgb, var(--nv-ink) 40%, transparent)")}>{n.date}</div>
              </Interactive>
            ))}
          </div>
        </div>
        <div style={css("border:1px solid var(--nv-edge);border-radius:var(--nv-radius);padding:26px 32px;background:var(--nv-glass);box-shadow:inset 0 1px 0 var(--nv-spec);overflow-y:auto")}>
          <div style={css(`font:var(--nv-micro-s);letter-spacing:var(--nv-micro-track-wide);color:${v.openNoteTypeColor}`)}>{v.openNoteType}</div>
          <h2 style={css("margin:10px 0 0;font:400 32px/1.15 var(--nv-font-serif)")}>{v.openNoteTitle}</h2>
          <div style={css("margin-top:8px;font:var(--nv-micro-m);color:color-mix(in srgb, var(--nv-ink) 40%, transparent)")}>{v.openNoteMeta}</div>
          {v.openNoteUrl && (
          ...
          {v.openNoteStudio && (
            <div style={css("margin-top:12px;display:flex;gap:8px;align-items:center;flex-wrap:wrap")}>
              <Interactive as="span" onClick={v.openNoteStudio.advance} title="Advance along the pipeline: seed → outlining → scripting → shipped"
                base={{ cursor: 'pointer', font: 'var(--nv-micro-s)', letterSpacing: 'var(--nv-micro-track)', padding: '5px 12px', borderRadius: '6px', color: 'var(--nv-vi)', border: '1px solid color-mix(in srgb, var(--nv-vi) 45%, transparent)', background: 'color-mix(in srgb, var(--nv-vi) 08%, transparent)' }}
              ...
              <Interactive as="span" onClick={v.openNoteStudio.outlineBusy ? undefined : v.openNoteStudio.outline}
                base={{ cursor: 'pointer', font: 'var(--nv-micro-s)', letterSpacing: 'var(--nv-micro-track)', padding: '5px 12px', borderRadius: '6px', color: 'var(--nv-gold)', border: '1px solid color-mix(in srgb, var(--nv-gold) 40%, transparent)', opacity: v.openNoteStudio.outlineBusy ? 0.5 : 1 }}
              ...
              <Interactive as="span" onClick={v.openNoteStudio.outlineTonight} title="Drafts in the overnight window — waiting in your Inbox at dawn"
                base={{ cursor: 'pointer', font: 'var(--nv-micro-s)', letterSpacing: 'var(--nv-micro-track)', padding: '5px 12px', borderRadius: '6px', color: 'var(--nv-cy)', border: '1px solid color-mix(in srgb, var(--nv-cy) 35%, transparent)' }}
          ...
          {v.reviewShowReflect && (
            <div style={css("margin-top:24px;max-width:640px;padding:16px 18px;border-radius:12px;border:1px solid color-mix(in srgb, var(--nv-vi) 35%, transparent);background:color-mix(in srgb, var(--nv-vi) 06%, transparent)")}>
              <div style={css("display:flex;justify-content:space-between;align-items:center")}>
                <span style={css("font:var(--nv-micro-m);letter-spacing:var(--nv-micro-track-wide);color:var(--nv-vi)")}>TODAY'S REVIEW · SUMMARY</span>
                ...
                <div style={css("margin-top:16px;padding-top:16px;border-top:1px solid color-mix(in srgb, var(--nv-vi) 15%, transparent)")}>
                  <div style={css("display:flex;justify-content:flex-end")}>
                    <Interactive
                      ...
                      base={{ cursor: 'pointer', font: 'var(--nv-micro-m)', padding: '5px 10px', borderRadius: '6px', color: '#cbb6f2', opacity: v.reviewReflectPromptBusy ? .6 : 1 }}
                  ...
                  <div style={css("margin-top:10px;display:flex;justify-content:flex-end")}>
                    <Interactive
                      ...
                      base={{ cursor: 'pointer', font: 'var(--nv-micro-m)', padding: '7px 14px', borderRadius: '7px', background: 'var(--nv-vi)', color: '#1a1322', opacity: v.reviewReflectBusy ? .6 : 1 }}
          ...
          <div style={css("margin-top:26px;padding-top:16px;border-top:1px solid color-mix(in srgb, var(--nv-ink) 08%, transparent)")}>
            <div style={css("font:var(--nv-micro-s);letter-spacing:var(--nv-micro-track-wide);color:color-mix(in srgb, var(--nv-ink) 40%, transparent)")}>LINKED IN GALAXY</div>
