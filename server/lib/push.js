...
export function pushForRecord(record) {
  ...
  const KIND_LABEL = {
    ...
    'training-check': 'Training check', 'food-suggestion': 'Food suggestion', calendar: 'Calendar change', compost: 'Vault hygiene', 'week-plan': 'Week plan', 'plan-today': 'Plan today', 'weekly-debrief': 'Weekly debrief', pattern: 'Pattern noticed', autonomy: 'Trust ladder',
  };
